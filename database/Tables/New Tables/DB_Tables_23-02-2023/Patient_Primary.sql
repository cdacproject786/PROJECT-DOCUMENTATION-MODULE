...
SECURITY_QUESTIONS_ID INT(10) NOT NULL UNIQUE,
...
CONSTRAINT fk_patient_med_record FOREIGN KEY (UID) REFERENCES PATIENT_MED_RECORD(UID) ON DELETE CASCADE ON UPDATE CASCADE,
